module github.com/oneliang/frame-golang/pen_stroke

go 1.22.2

require (
	github.com/oneliang/util-golang/constants v0.0.0-20240424080518-b855d0299252
	github.com/oneliang/util-golang/file v0.0.0-20240424080518-b855d0299252
